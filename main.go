...
//again:
//	index++
//	xxx := lockPool.Get().([]int)
//	println(xxx)
//	defer lockPool.Put(xxx)
//
//	if index == 1 {
//		goto again
//	}
...
func main() {
	//var rect2 = Rect{Point{0, 0}, Point{5, 5}}
	//var rect1 = Rect{Point{5, 0}, Point{10, 5}}
	//mergeRect := MergeRect(rect1, rect2)
	//
	//if mergeRect != nil {
	//	fmt.Printf("%v\n", *mergeRect)
	//}
	//var rect1 = Rect{Point{0, 0}, Point{5, 5}}
	//var rect2 = Rect{Point{0, 5}, Point{5, 30}}
	//mergeRect := MergeRect(rect1, rect2)
	//
	//if mergeRect != nil {
	//	fmt.Printf("%v\n", *mergeRect)
	...
	//
	//result := r1.ToImageRect().Intersect(r2.ToImageRect())
	...
	//flag := root.InsertRect(Rect{Point{0, 0}, Point{30, 30}})
	//println(flag)
	//flag = root.FreeRect(Rect{Point{0, 0}, Point{15, 15}})
	//println(flag)
	//flag = root.FreeRect(Rect{Point{0, 15}, Point{15, 30}})
	//println(flag)
	//flag = root.FreeRect(Rect{Point{15, 15}, Point{30, 30}})
	//println(flag)
	//
	//flag = root.InsertRect(Rect{Point{60, 10}, Point{80, 30}})
	//println(flag)
	//
	//flag = root.InsertRect(Rect{Point{60, 60}, Point{80, 80}})
	//println(flag)
